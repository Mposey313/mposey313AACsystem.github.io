...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" width="80%" style="border:1px solid #033; color:#033;">
     ...
     <tr>
     <th colspan="7" align="center" height="55px" style="border-bottom:1px solid #033; background: purple; color:#FFF;">AIRCRAFTS</th>
    </tr>
    
      <tr height="30px">
        <th style="border-bottom:1px solid #333;">Aircraft ID </th>
         <th style="border-bottom:1px solid #333;">Aircraft Name </th>
        <th style="border-bottom:1px solid #333;"> Chief Designer </th>
        <th style="border-bottom:1px solid #333;"> Description</th>
        <th style="border-bottom:1px solid #333;"> Primary Customer</th>
          <th style="border-bottom:1px solid #333;"> List of Parts</th>
        ...
        <th style="border-bottom:1px solid #333;"> Action </th>
					...
					if(isset($_GET['search'])){
						...
						$sql = "select * from aircraft where a_id like '%$query%' or AIRCRAFT_NAME like '%$query%'";
        ...
        <td style="border-bottom:1px solid #333;"> <?php echo $row1['AIRCRAFT_NAME']; ?> </td>
        <td style="border-bottom:1px solid #333;"> <?php echo $row1['CHIEF_DESIGNER']; ?>  </td>
        <td style="border-bottom:1px solid #333;"><?php echo $row1['DESCRIPTION']; ?> </td>
        <td style="border-bottom:1px solid #333;"> <?php echo $row1['PRIMARY_CUSTOMER']; ?> </td>
        <td style="border-bottom:1px solid #333;"> <?php echo $row1['LIST_OF_PARTTS']; ?> </td>
